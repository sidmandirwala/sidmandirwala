...
| Role | Company | Period |
|------|---------|--------|
| **Software Engineer Intern** | [AI4Purpose Inc.](https://ai4purpose.com/) | Feb 2026 — Present |
| **Software Development Engineer Intern** | KeyToZ | Jan 2024 — Jul 2024 |
| **Full Stack Developer Intern** | Bharat Tech Labs | Jul 2023 — Aug 2023 |
...
|----------|-------------------|
| **Automobile Enthusiast** | Whether it's the engineering behind a new EV drivetrain or the sound of a well-tuned engine, cars and bikes have fascinated me for as long as I can remember. |
| **Cricket Lover** | There's something about the strategy and patience in test cricket that I genuinely enjoy — always up for a match, on screen or on the field. |
| **Tech Lover** | Even my downtime circles back to tech — exploring new tools, reading about system design, and tinkering with side projects just to see how things work under the hood. |
